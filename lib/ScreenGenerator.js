...
exports.ScreenGenerator = class ScreenGenerator extends ScreenBase {
  ...
  _checkBaseUrl() {
    ...
    if ((slashes && slashes.length > 2) || (hashes && hashes.length)) this.output.displayFailure('  baseUrl should not include slashes or hashes. Please handle all pathing in test\'s config file');
  }
