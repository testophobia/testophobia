    ...
    if (element) {
      switch (config.type) {
        ...
        case 'removeAttribute':
          ...
          return element;
        case 'input':
          //doing this temporarily, until el.type() works reliably - https://github.com/GoogleChrome/puppeteer/issues/1648
  ...
  if (el) {
    switch (action.type) {
      case 'clearInput':
        ...
        break;
      case 'input':
        //not working for me - https://github.com/GoogleChrome/puppeteer/issues/1648
      ...
      case 'drag':
        try {
          ...
          if (center) {
            ...
            await page.mouse.move(center.x + xDelta, center.y + yDelta, {steps: 10});
            await page.mouse.up();
          }
        } catch (err) {
