...
exports.resolveNodeModulePath = (fileToCheck = "") => {
  let nodeModulesPath = path.join(__dirname, '../../../');
  if ((fileToCheck && !path.join(nodeModulesPath, fileToCheck) || (!fileToCheck && nodeModulesPath && path.basename(nodeModulesPath) !== 'node_modules'))) {
