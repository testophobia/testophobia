...
import {configDefaults} from '../config/load-config.js';
import path from 'path';
import inquirer from '../../deps/inquirer.js';

/**
 * Prompt the user for config/test file paramaters and generate the file
 *
 * @param {object} config The Testophobia config file
 * @param {string} outputDir Directory to generate the output file
 * @param {function} cb Callback function to be called upon completion
 */
export const generateConfigFile = async (config, outputDir, cb) => {
