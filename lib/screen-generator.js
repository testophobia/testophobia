...
exports.ScreenGenerator = class ScreenGenerator extends ScreenBase {
  ...
  async handleScreenshot(screenType, testRouteName) {
    if (!(this.test.actions && this.test.actions.filter(a => a.excludeDimensions.includes(screenType).length))) this.prependDebugMessageToSpinner(`Generating Screenshot - ${testRouteName} (${screenType})`);
