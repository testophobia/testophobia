...
exports.Configuration = class Configuration {
  ...
  _configure() {
    ...
    this.target = this.testPath ? this.testPath : this.passedConfigTests ? this.passedConfigTests : this.cli.input[0] ? this.cli.input[0] : this.config.tests;
  }
